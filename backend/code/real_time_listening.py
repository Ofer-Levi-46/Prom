...
class Listener:
    ...
    def __init__(self, sampling_rate: int, start_key: str, end_key: str, on_start, on_while_interest, on_end, duration=0.1):
        """
